...
namespace _19_Atividade_CRUD.Controllers
{
    ...
    public class ContatoController : Controller
    {
        ...
        {
            var appDbContext = _context.Contatos.Include(c => c.Categoria);
        ...
        public async Task<IActionResult> Create([Bind("JogoId,Nome,Descricao,Imagem,Ativo,CategoriaId")] Contato contato)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "CategoriaId", contato.CategoriaId);
            return View(contato);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContatoId,Nome,Descricao,Imagem,Ativo,CategoriaId")] Contato contato)
        {
